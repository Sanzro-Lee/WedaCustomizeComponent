    ...
    reactThisBinding.vueInstance = new Vue({
      ...
      render(createElement) {
        const wrappedSlots = Object.keys(props).reduce((acc, key) => {
          ...
          if ( /*#__PURE__*/React.isValidElement(prop)) {
...
var ReactWrapper = {
  ...
  methods: {
    mountReactComponent(component) {
      ...
      ReactDOM.render( /*#__PURE__*/React.createElement(Component, _extends({}, this.$props.passedProps, this.$attrs, this.$listeners, children, {
...
function ReactResolver(component) {
  return isReactComponent(component) ? component : props => /*#__PURE__*/React.createElement(VueContainer, _extends({}, props, {
    component: component
  }));
}
/**
...
const WedaVueWrapper = /*#__PURE__*/React.memo(function WedaVueWrapper(props) {
  const {
    events,
    ...restProps
  } = props;
  ...
  }, /*#__PURE__*/React.createElement(VueContainer, _extends({
    on: events,
    styles: styles
  }, restProps)));
});

export { VueResolver as ReactInVue, ReactWrapper, ReactResolver as VueInReact, VuePlugin, VueContainer as VueWrapper, WedaVueWrapper, babelReactResolver as __vueraReactResolver, config };
